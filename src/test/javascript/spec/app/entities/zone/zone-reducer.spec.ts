...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes(
        [REQUEST(ACTION_TYPES.FETCH_ZONE_LIST), REQUEST(ACTION_TYPES.SEARCH_ZONES), REQUEST(ACTION_TYPES.FETCH_ZONE)],
        {},
        state => {
          expect(state).toMatchObject({
            errorMessage: null,
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.SEARCH_ZONES),
  ...
  describe('Successes', () => {
    ...
    it('should search all entities', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.SEARCH_ZONES),
          payload,
        })
      ).toEqual({
        ...initialState,
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.SEARCH_ZONES actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.SEARCH_ZONES),
        },
        {
          type: SUCCESS(ACTION_TYPES.SEARCH_ZONES),
          payload: resolvedObject,
