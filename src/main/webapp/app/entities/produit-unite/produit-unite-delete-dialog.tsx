...
export const ProduitUniteDeleteDialog = (props: IProduitUniteDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="elbazarApp.produitUnite.delete.question">
        <Translate contentKey="elbazarApp.produitUnite.delete.question" interpolate={{ id: produitUniteEntity.id }}>
          Are you sure you want to delete this ProduitUnite?
        </Translate>
      </ModalBody>
      <ModalFooter>
