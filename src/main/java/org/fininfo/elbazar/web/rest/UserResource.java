...
import org.fininfo.elbazar.service.dto.common.UserCheckDTO;
import org.fininfo.elbazar.web.rest.errors.BadRequestAlertException;
import org.fininfo.elbazar.web.rest.errors.EmailAlreadyUsedException;
import org.fininfo.elbazar.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public User checkUser(@Valid @RequestBody UserCheckDTO userCheckDTO) {
        if (userRepository.findOneByEmailIgnoreCase(userCheckDTO.getEmailUser()).isPresent()) {
            throw new EmailAlreadyUsedException();
        } else {
            return  null ;
        }
